        ...
        return(
            <animated.div id="main_form" style={form_styles}>
                ...
                <div id="request_type_selector">
                    ...
                    <div id="sign_in" className={"pointer"} onPointerDown={selector_changer}><div className="text_container">Sign In</div></div>
                    <div id="new_account" className={"pointer"} onPointerDown={selector_changer}><div className="text_container">Sign Up</div></div>
                </div>

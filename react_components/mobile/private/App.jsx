...
function App() {
    ...
    const [messages_view_type, set_messages_view_type] = useState(false);
            ...
            <div id="mainContainer">
                ...
                <ChatList   
                    api={{
                        ...
                        close_prev: close_sum_menu,
                        rooms: set_container_view_type,
                        search: set_search_view_type,
                        settings: set_settings_view_type,
                        headerText: setHeaderText,
                        select: select
                    }}
    
                    states={{
                        view: container_view_type,
                ...
                <Search 
                    ...
                    states={{
                        view: search_view_type,
                        friends: id_changer.current
                    }}
                />

                <ProfileSettings visible={settings_view_type} data={userData.current} />
                ...
                <Messages
                    ...
                    mainSideTop_ref={mainSideTop_ref}
                    msg_codes={msg_codes}
                />
            </div>
        );
